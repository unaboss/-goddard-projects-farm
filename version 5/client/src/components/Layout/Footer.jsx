        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.to}>
                  <Link to={link.to} className="text-gray-300 hover:text-gold-400 text-sm transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={item.label} className="flex items-center gap-2 text-gray-300 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="tel:+27820406558" className="flex items-center gap-2 text-gray-300 hover:text-gold-400 text-sm transition-colors">
                  <Phone className="w-4 h-4 text-gold-500 flex-shrink-0" />
                  082 040 6558
                </a>
              </li>
              <li>
                <a href="tel:+27714461512" className="flex items-center gap-2 text-gray-300 hover:text-gold-400 text-sm transition-colors">
                  <Phone className="w-4 h-4 text-gold-500 flex-shrink-0" />
                  +27 71 446 1512
                </a>
              </li>
              <li>
                <a href="mailto:info@rendeals4.co.za" className="flex items-center gap-2 text-gray-300 hover:text-gold-400 text-sm transition-colors">
